...
VALUES
    ...
    ('운영관리자','operadmin@test.com','$2a$10$D65zesWQWcOekANz1GW0OeZ/PH3CRK/vhb3tDUrCsDSoEFSfw8z/m','010-8888-8888','OPERATION_ADMIN','PENDING',false,NOW(),NOW()),
...
VALUES
    ...
    ('홍길동5','user5@test.com','010-1000-0005','INACTIVE',false,NOW(),NOW()),
    ('김철수1','user6@test.com','010-2000-0001','ACTIVE',false,NOW(),NOW()),
    ('김철수2','user7@test.com','010-2000-0002','ACTIVE',false,NOW(),NOW()),
    ('김철수3','user8@test.com','010-2000-0003','SUSPENDED',false,NOW(),NOW()),
    ...
    ('박민수2','user13@test.com','010-4000-0002','INACTIVE',false,NOW(),NOW()),
...
VALUES
    ...
    ('마우스1','전자기기',30000,50,'FOR_SALE',false,2,NOW(),NOW()),
    ('마우스2','전자기기',35000,40,'FOR_SALE',false,2,NOW(),NOW()),
    ('마우스3','전자기기',28000,60,'FOR_SALE',false,2,NOW(),NOW()),
    ('키보드1','전자기기',50000,30,'FOR_SALE',false,3,NOW(),NOW()),
    ('키보드2','전자기기',70000,20,'FOR_SALE',false,3,NOW(),NOW()),
    ('키보드3','전자기기',60000,25,'FOR_SALE',false,3,NOW(),NOW()),
    ('모니터1','전자기기',200000,15,'FOR_SALE',false,1,NOW(),NOW()),
    ('모니터2','전자기기',250000,10,'FOR_SALE',false,1,NOW(),NOW()),
    ('모니터3','전자기기',220000,18,'FOR_SALE',false,2,NOW(),NOW()),
    ('스피커1','전자기기',80000,35,'FOR_SALE',false,2,NOW(),NOW()),
    ('스피커2','전자기기',90000,28,'FOR_SALE',false,3,NOW(),NOW()),
    ('스피커3','전자기기',85000,32,'FOR_SALE',false,3,NOW(),NOW()),
    ('의자1','가구',120000,20,'FOR_SALE',false,1,NOW(),NOW()),
    ('의자2','가구',150000,15,'FOR_SALE',false,1,NOW(),NOW()),
    ('의자3','가구',130000,18,'FOR_SALE',false,2,NOW(),NOW()),
    ('책상1','가구',200000,12,'FOR_SALE',false,2,NOW(),NOW()),
    ('책상2','가구',250000,10,'FOR_SALE',false,3,NOW(),NOW()),
    ('책상3','가구',220000,14,'FOR_SALE',false,3,NOW(),NOW()),
...
VALUES
    ...
    (5,5,1,1,35000,'DELIVERED',NULL,'ORD-005',false,NOW(),NOW()),
    ...
    (13,13,1,1,80000,'CANCELED','파손','ORD-013',false,NOW(),NOW()),
